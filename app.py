...
def simular():
    if request.method == 'POST':
      ...
      n = 3 # espessura da linha
      nn = 1 # espessura do tracejado
      tempo = tempo*1000
      t1 = t1*1000
      t2 = t2*1000
      t3 = t3*1000
      ...
      plt.subplot(2, 2, 1)
      plt.plot(t2, m2*1000, color='blue',linewidth=n)  # Azul
      plt.plot(t1, m1*1000, color='blue',linewidth=n)  # Azul
      plt.plot(t3, m3*1000, color='blue',linewidth=n)  # Azul
      plt.plot(t4, m4*1000, color='blue',linewidth=n)  # Azul
      plt.axvline(x=0, color='black', linestyle='--', linewidth=nn)
      plt.axvline(x=tempo, color='black', linestyle='--', linewidth=nn)  # Linha vertical tracejada preta em t = 0.0428
      plt.axvline(x=2*tempo, color='black', linestyle='--', linewidth=nn)
      plt.axvline(x=3*tempo, color='black', linestyle='--', linewidth=nn)
      plt.axvline(x=4*tempo, color='black', linestyle='--', linewidth=nn)
      plt.ylabel('Massa (g)', fontweight='bold')
      plt.grid(False) #True
      plt.text(tempo/2, plt.ylim()[1] * 1.02, 'ADMISSÃO', horizontalalignment='center', fontweight='bold')
      plt.text(tempo/2 + tempo, plt.ylim()[1] * 1.02, 'COMPRESSÃO', horizontalalignment='center', fontweight='bold')
      plt.text(tempo/2 + 2*tempo, plt.ylim()[1] * 1.02, 'COMBUSTÃO', horizontalalignment='center', fontweight='bold')
      plt.text(tempo/2 + 3*tempo, plt.ylim()[1] * 1.02, 'ESCAPE', horizontalalignment='center', fontweight='bold')

      plt.subplot(2, 2, 2)
      plt.plot(t2, T2 - 273.15, color='red',linewidth=n)  # Vermelho
      plt.plot(t1, T1 - 273.15, color='red',linewidth=n)  # Vermelho
      plt.plot(t3, T3 - 273.15, color='red',linewidth=n)  # Vermelho
      plt.plot(t4, T4 - 273.15, color='red',linewidth=n)  # Vermelho
      plt.axvline(x=0, color='black', linestyle='--', linewidth=nn)
      plt.axvline(x=tempo, color='black', linestyle='--', linewidth=nn)  # Linha vertical tracejada preta em t = 0.0428
      plt.axvline(x=2*tempo, color='black', linestyle='--', linewidth=nn)
      plt.axvline(x=3*tempo, color='black', linestyle='--', linewidth=nn)
      plt.axvline(x=4*tempo, color='black', linestyle='--', linewidth=nn)
      plt.ylabel('Temperatura (Celsius)', fontweight='bold')
      plt.grid(False)
      plt.text(tempo/2, plt.ylim()[1] * 1.02, 'ADMISSÃO', horizontalalignment='center', fontweight='bold')
      plt.text(tempo/2 + tempo, plt.ylim()[1] * 1.02, 'COMPRESSÃO', horizontalalignment='center', fontweight='bold')
      plt.text(tempo/2 + 2*tempo, plt.ylim()[1] * 1.02, 'COMBUSTÃO', horizontalalignment='center', fontweight='bold')
      ...
      plt.subplot(2, 2, 3)
      plt.plot(t2, S2, color='green',linewidth=n)  # Verde
      plt.plot(t1, S1, color='green',linewidth=n)  # Verde
      plt.plot(t3, S3, color='green',linewidth=n)  # Verde
      plt.plot(t4, S4, color='green',linewidth=n)  # Verde
      plt.axvline(x=0, color='black', linestyle='--', linewidth=nn)
      plt.axvline(x=tempo, color='black', linestyle='--', linewidth=nn)  # Linha vertical tracejada preta em t = 0.0428
      plt.axvline(x=2*tempo, color='black', linestyle='--', linewidth=nn)
      plt.axvline(x=3*tempo, color='black', linestyle='--', linewidth=nn)
      ...
      plt.ylabel('Entropia (J/kg.K)', fontweight='bold')
      plt.grid(False)


      plt.subplot(2, 2, 4)
      plt.plot(t2, X2/1000, color='purple',linewidth=n)  # Roxo
      plt.plot(t1, X1/1000, color='purple',linewidth=n)  # Roxo
      plt.plot(t3, X3/1000, color='purple',linewidth=n)  # Roxo
      plt.plot(t4, X4/1000, color='purple',linewidth=n)  # Roxo
      plt.axvline(x=0, color='black', linestyle='--', linewidth=nn)
      plt.axvline(x=tempo, color='black', linestyle='--', linewidth=nn)  # Linha vertical tracejada preta em t = 0.0428
      plt.axvline(x=2*tempo, color='black', linestyle='--', linewidth=nn)
      plt.axvline(x=3*tempo, color='black', linestyle='--', linewidth=nn)
      plt.axvline(x=4*tempo, color='black', linestyle='--', linewidth=nn)
      plt.xlabel('Tempo (ms)', fontweight='bold')
      plt.ylabel('Exergia (kJ)', fontweight='bold')
      plt.grid(False)
